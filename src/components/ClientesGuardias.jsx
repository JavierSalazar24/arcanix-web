      ...
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
        <div className='text-center mb-16'>
          ...
          <h2 className='text-4xl md:text-5xl font-bold text-gray-900 mb-6'>
            Clientes que ya <span className='text-blue-600'>transformaron</span>{' '}
            su operación
          </h2>
          ...
          <div className='grid justify-center gap-6 grid-cols-[repeat(auto-fit,minmax(280px,500px))]'>
            {clientes.map((company) => (
              <a
                ...
                className='group flex flex-col items-center justify-center p-8 bg-gradient-to-br hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 cursor-pointer relative overflow-hidden from-blue-50 to-indigo-50 rounded-2xl border-2 border-blue-200 hover:border-blue-400'
              >
        ...
        <div className='text-center'>
          <p className='text-gray-400 italic'>
            Haz clic en cualquier empresa para conocer más sobre ellos
          </p>
        </div>
      </div>
    </section>
